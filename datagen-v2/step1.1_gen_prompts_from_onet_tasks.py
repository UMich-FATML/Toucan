...
Example:
  python step1.1_gen_prompts_from_onet_tasks.py --num_tasks 2 --total_prompts 100
"""
...
def resolve_script_relative_path(script_dir: str, path: str) -> str:
...
def main() -> None:
  ...
  args.output_folder = resolve_script_relative_path(script_dir, args.output_folder)
  args.mcp_servers_dir = resolve_script_relative_path(script_dir, args.mcp_servers_dir)
